...
int compute_NoUnifiedMem(void) {
    ...
    cudaMalloc((void **) &device_a, NUM_ELEM * sizeof(float));
    cudaMalloc((void **) &device_b, NUM_ELEM * sizeof(float));
    ...
    cudaMemcpy(host_b, device_b, NUM_ELEM, cudaMemcpyDeviceToHost);
